...
/**
 * Servlet implementation class GetSingleInformation
 */
@WebServlet("/GetSingleInformation")
public class GetSingleInformation extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetSingleInformation() {
		super();
