...
/**
 * Servlet implementation class IncreaseRating
 */
@WebServlet("/IncreaseRating")
public class IncreaseRating extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = RatingService.IncreaseRating(idUser, idHotel);
		...
		if (partner.equals("1")) {
			information.get(0).getInformation().setRooms(GetRoom.getRoom(Integer.parseInt(information.get(0).getInformation().getId())));
		} else {
			
			information.get(0).getInformation().setFood(GetFood.getFood(Integer.parseInt(information.get(0).getInformation().getId())));
		}
		information.get(0).getInformation().setPartner(partner);
		List<InforRating> informationnear = GetInformationnear.GetInformation(partner, information.get(0).getInformation().getDistrict(),
				information.get(0).getInformation().getProvince());
