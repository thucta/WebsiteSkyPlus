...
public class GetInforFollowDistrict {

	public static List<InforRating> GetListInforsfollowDistrict(String district, String partner, String province) throws UnsupportedEncodingException {
		String data = BasicService.getData(Config.URLADDRESS + "/infor/search?partner=" + partner + "&&district="
				+ URLEncoder.encode(district, "UTF-8") + "&&province=" + URLEncoder.encode(province, "UTF-8"));
	...
	public static List<InforRating> GetListInforsfollowProvince(String partner, String province) throws UnsupportedEncodingException {
		String data = BasicService.getData(Config.URLADDRESS + "/infor/search?partner=" + partner  + "&province=" + URLEncoder.encode(province, "UTF-8"));
		try
		{
		JSONObject jsonObject = new JSONObject(data);
		List<InforRating> listInfor = new ArrayList<>();
