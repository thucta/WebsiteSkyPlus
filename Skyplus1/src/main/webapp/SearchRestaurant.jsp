...
<body style="font-family: sans-serif;">
	<%
		/* String partner = "";
		request.getRequestDispatcher("./GetTypeofHotel").forward(request, response);
		request.getRequestDispatcher("./GetTopRatingfollowPartner?partner=" + partner).forward(request, response); */
		//request.getRequestDispatcher("").forward(request, response);
		List<InforRating> information = (List<InforRating>) request.getAttribute("search");
		if (information == null) {
			information = (List<InforRating>) request.getAttribute("TopRestaurant");
			if (information == null) {
				request.getRequestDispatcher("./GetTopRestaurant").forward(request, response);
				return;
			}
	...
	<div class="container">
		<div class="row">
							...
							<div class=" pull-left">
								<div class="tile-group no-margin no-padding stream-list"
									...
									<div class="widget-details">
										...
										%>
										<a
											href="<%="./GetSingleInformation?partner=2&name=" + information.get(i).getInFor().getId()%>">
			...
			<div class="col-md-3">
				...
				<div class="widget widget_search">
					...
					<div class="widget-details">
						<form action="./Search" class="search-form">
							...
							<input type="hidden" id="partner" name="partner" value="2">
				...
				<hr class="thin" style="background-color: #e74c3c">
				<%
					List<String> types = (List<String>) request.getAttribute("type");
				%>
				<form action="./SearchType">
					<input type="hidden" id="partner" name="partner" value="2">
					<div class="widget widget_categories">
						<h4 class="widget-title">Lọc theo Thể loại</h4>
						<!-- /.widget-title -->
						<div class="widget-details">
							<div class="categories-list">
						...
						<div class="widget-details">
							<div class="categories-list">
								<select id="money" name="money" class="form-control">
									...
									<option value="3">Từ 100.000 đến 150.000</option>
									<option value="4">Từ 150.000 đến 200.000</option>
									<option value="5">Trên 200.000</option>
								</select>
							</div>
							<!-- /.categories-list -->
						</div>
